...
suite "Provider test":
    ...
    test "Async":
        let image = waitFor asyncWebImage("https://upload.wikimedia.org/wikipedia/ru/e/e7/Steve_%28Minecraft%29.png")
        let bot = newChatCompletion("claude-sonnet-4.6", Provider.AirForce, @[
            newMessage("system", "you are a helpful ai chat bot. If you don't know the answer to user's question just tell 'I dont know' them"),
            newImageMessage("user", "привет, когда выйдет фильм по этой игре?", image)
        ], true)
